---
title: 'Collaborate Securely: How to Use Proton Drive for File Sharing'
...
Because of its end-to-end encryption, sharing from Proton Drive is fundamentally more secure than with other services. Here’s how to do it.

### How to Share Files and Folders Securely

Proton Drive gives you granular control over how you share your data. The core of this system is the **secure link**.

1.  **Select Your File or Folder:** From the Proton Drive web or mobile app, find the file or folder you wish to share.
2.  **Generate a Sharing Link:** Click the "Share" or "Get link" option. This creates a unique, encrypted link. By default, only you can access this link.
3.  **Enable Public Access:** To share it, you must enable public access for the link. This is an explicit step, ensuring you never share files by accident.

Once the link is public, anyone with the link can view or download the file or folder. But Proton Drive gives you more control than that.

### Add a Layer of Protection with a Password
...
How many times have you sent a link and forgotten it's still active months or years later? This can be a significant security risk.

Proton Drive solves this by allowing you to set an **expiration date** for your shared links. You can set the link to expire in a day, a week, a month, or on a custom date. Once the date passes, the link automatically becomes invalid, protecting your data from unintended future access.
