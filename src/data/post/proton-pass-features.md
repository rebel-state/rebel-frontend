---
title: 'Beyond Passwords: Using Aliases and Notes in Proton Pass'
publishDate: 2026-02-05T00:00:00Z
category: 'How-To'
tags: ['Proton Pass', 'Features', 'Privacy']
description: 'Proton Pass is more than a password manager. Learn how to use its powerful identity management features, like email aliases and encrypted notes, to shield your digital life from spam and data breaches.'
image: 'https://pmecdn.protonweb.com/image-transformation/?s=c&image=images%2Ff_auto%2Cq_auto%2Fv1765275257%2Fwp-pme%2Fproton-pass-cli_blog_cover%2Fproton-pass-cli_blog_cover.png%3F_i%3DAA'
---
...
**What it is:**
An email alias is a unique, randomly generated email address (e.g., `service.xyz@passmail.net`) that forwards all incoming mail to your primary inbox.

**How it works:**
When you're creating a new account, the Proton Pass browser extension will offer to create an alias for you with a single click. You use this alias to sign up. The service sends emails to the alias, and Proton forwards them to you.
...
**What it is:**
Proton Pass allows you to create **encrypted notes** within your vault. These are free-form notes that are protected by the same robust, end-to-end encryption as your passwords.

**How it works:**
You can create a new note from within the Proton Pass app or browser extension. Give it a title and add your content. You can also store credit card details in a pre-formatted entry type. Once saved, the information is encrypted and securely synced across all your devices.
